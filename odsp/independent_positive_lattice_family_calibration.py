"""Prospective null calibration for the independent 12-edge directional lattice family."""
...
GENERATOR_VERSION = (
    "analytic_independent_group_equicorrelated_contrasts_one_sided_lattice_family_v1"
)


@dataclass(frozen=True)
class IndependentDirectionalLatticeFamilyScenario:
    scenario_id: str
    distribution: str
...
@dataclass(frozen=True)
class IndependentDirectionalLatticeFamilyCalibration:
    ...
    scenarios: tuple[IndependentDirectionalLatticeFamilyScenario, ...]
...
def run_independent_directional_lattice_family_calibration(
    *,
    seed: int = 20260922,
...
) -> IndependentDirectionalLatticeFamilyCalibration:
    """Run the frozen three-scenario 12-contrast independent global-null panel."""
    ...
    scenario_defs = (
        ("independent-c12-normal-b20", "normal", 20, 12),
        ("independent-c12-normal-b50", "normal", 50, 12),
        ("independent-c12-t3-b20", "student_t3", 20, 12),
    )
    ...
    rows_out: list[IndependentDirectionalLatticeFamilyScenario] = []
    ...
    for scenario_index, (
        ...
        rows_out.append(
            IndependentDirectionalLatticeFamilyScenario(
    ...
    return IndependentDirectionalLatticeFamilyCalibration(
