...
def axis_thickness_map(
    ...
    *,
    ...
    assigned an artificial thickness of one. The horizontal-mass array is ordered
    as ``horizontal_axes``; added-state order has no effect on entropy.
    ...
    permutation = tuple(surviving_original_order.index(axis) for axis in keep)
