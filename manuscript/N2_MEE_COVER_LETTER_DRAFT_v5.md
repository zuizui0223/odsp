# Cover letter draft — Methods in Ecology and Evolution — state-prediction v5
...
Because species identity was itself a predictor in the BOP model, v5 also reports an explicitly post-outcome descriptive decomposition of the already frozen primary gain. Across the 30 held-out individuals, the mean total gain of `0.57091` nats/event decomposes into a pooled-to-species baseline component of `0.07279` and a within-species context component of `0.49812`. For *Circus pygargus*, `0.93237` of the `1.24613` mean gain is the within-species context component; *Buteo buteo* shows the contrasting pattern, with a positive species component and slightly negative mean within-species context component. This amendment did not refit the model, re-access raw tracking data, retune any setting, replace the prospective comparator or change the 27/30 mixed terminal decision. We report it to make the interpretation of the frozen primary gain transparent rather than to reclassify the endpoint.
