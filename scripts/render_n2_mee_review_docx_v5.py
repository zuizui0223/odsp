#!/usr/bin/env python3
"""Render the validated N2 MEE v5 manuscript to anonymous review DOCX.

The layout implementation is intentionally reused from the already validated v4
renderer. This wrapper changes only the source version and manifest role.
"""
...
def render(markdown: Path, output: Path, manifest: Path | None = None) -> dict[str, object]:
    ...
    result["role"] = "n2_mee_anonymous_review_docx_v5"
    result["source_version"] = 5
