#!/usr/bin/env python3
"""Validate the canonical BOP population-transfer amendment receipt."""
...
def validate(result_path: Path) -> None:
    ...
    for key in ("contract_id", "post_outcome_amendment", "analysis_type"):
...
def main() -> None:
    ...
    print("BOP population-transfer amendment receipt validated")
